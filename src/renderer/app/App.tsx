...
export default function App() {
  ...
  return (
    <div className="p-5 bg-slate-200 dark:bg-slate-900 dark:text-slate-200 max-w-screen min-h-screen">
      ...
      <ThemeButton className="absolute top-5 right-5 p-2 w-10 h-10 rounded-full transition-colors hover:bg-slate-300 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-red-700" />
      <SelectLang
